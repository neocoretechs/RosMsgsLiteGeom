...
public class Quaternion implements Serializable {
  ...
  public static Quaternion rotationBetweenVectors(Vector3 vector1, Vector3 vector2) {
    assert(vector1.getMagnitude() > 0) : "Cannot calculate rotation between zero-length vectors.";
    assert(vector2.getMagnitude() > 0) : "Cannot calculate rotation between zero-length vectors.";
